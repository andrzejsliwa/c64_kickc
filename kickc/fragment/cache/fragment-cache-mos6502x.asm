...
ldy #0
sta ({z1}),y
//FRAGMENT vbuz1=vbuc1_band_vbuaa
and #{c1}
sta {z1}
//FRAGMENT vbuz1=vbuc1_band_vbuxx
lda #{c1}
sax {z1}
//FRAGMENT vbuz1=vbuc1_band_vbuyy
tya
and #{c1}
sta {z1}
...
lda #{c1}
and {z1}
//FRAGMENT vbuaa=vbuc1_band_vbuaa
and #{c1}
//FRAGMENT vbuaa=vbuc1_band_vbuxx
txa
and #{c1}
//FRAGMENT vbuaa=vbuc1_band_vbuyy
tya
and #{c1}
...
and {z1}
tax
//FRAGMENT vbuxx=vbuc1_band_vbuaa
ldx #{c1}
axs #0
...
and {c1}
tay
//FRAGMENT vbuxx=vbuc1_band_vbuyy
ldx #{c1}
tya
axs #0
//FRAGMENT vbuyy=vbuc1_band_vbuyy
tya
and #{c1}
tay
