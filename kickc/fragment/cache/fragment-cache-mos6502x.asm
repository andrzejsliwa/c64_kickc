...
ldy #0
sta ($fe),y
//FRAGMENT vbuz1=_byte_pbuz2
lda {z2}
sta {z1}
//FRAGMENT vbuaa=_byte_pbuz1
lda {z1}
//FRAGMENT vbuxx=_byte_pbuz1
ldx {z1}
//FRAGMENT vbuyy=_byte_pbuz1
ldy {z1}
...
bcc {la1}
!:
//FRAGMENT vbuz1=vbuc1_band_vbuz2
lda #{c1}
and {z2}
sta {z1}
//FRAGMENT vwuz1=vbuc1_minus_vwuz2
NO_SYNTHESIS
//FRAGMENT vwuz1=vbsc1_minus_vwuz2
NO_SYNTHESIS
//FRAGMENT vwuz1=vwuc1_minus_vwuz2
sec
lda #<{c1}
sbc {z2}
sta {z1}
...
bcs {la1}
!:
//FRAGMENT _deref_pbuc1=vwuz1
lda {z1}
sta {c1}
//FRAGMENT vbuaa=vbuc1_band_vbuz1
lda #{c1}
and {z1}
//FRAGMENT vbuxx=vbuc1_band_vbuz1
lda #{c1}
and {z1}
tax
//FRAGMENT vbuyy=vbuc1_band_vbuz1
lda #{c1}
and {z1}
tay
//FRAGMENT vbuz1=vbuc1_band_vbuxx
lda #{c1}
sax {z1}
//FRAGMENT vbuaa=vbuc1_band_vbuxx
txa
and #{c1}
//FRAGMENT vbuxx=vbuc1_band_vbuxx
lda #{c1}
axs #0
//FRAGMENT vbuyy=vbuc1_band_vbuxx
txa
and #{c1}
tay
